...
const MinimalImageTemplate = ({ data, accentColor }) => {
  ...
  return (
    // A4 CONTAINER (using h-auto on container & inner grid to collapse cleanly around content)
    <div className="w-[210mm] h-auto bg-white text-zinc-800 font-sans shadow-lg print:shadow-none overflow-hidden wrap-break-word">
