...
const ProfessionalTemplate = ({ data, accentColor }) => {
  ...
  return (
    <div className="w-[210mm] min-h-[297mm] h-full flex flex-col justify-between mx-auto bg-white text-black font-serif text-[14px] leading-snug p-8 shadow-md print:shadow-none overflow-hidden break-words">
