...
const ProfessionalTemplate = ({ data, accentColor }) => {
  ...
  return (
    ...
    <div className="w-[210mm] h-auto mx-auto bg-white text-black font-serif text-[14px] leading-snug p-8 shadow-md print:shadow-none overflow-hidden wrap-break-word">
