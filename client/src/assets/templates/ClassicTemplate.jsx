...
const ClassicTemplate = ({ data, accentColor }) => {
    ...
    return (
  /* Root A4 container uses flex flex-col justify-between */
  <div className="w-[210mm] min-h-[297mm] h-full flex flex-col justify-between mx-auto px-8 py-10 bg-white text-gray-800 shadow-lg font-serif print:shadow-none overflow-hidden break-words">
    ...
    {/* HEADER SECTION */}
    <header className="text-center mb-2 pb-3 border-b-2 shrink-0" style={{ borderColor: accentColor }}>
      <h1 className="text-3xl font-bold mb-1 uppercase tracking-tight" style={{ color: accentColor }}>
    ...
    {/* MIDDLE CONTENT: Uses flex-1 and flex-col with space-y-6 so sections distribute evenly */}
    <div className="flex-1 flex flex-col justify-evenly py-2">
      ...
      {data.experience && data.experience.length > 0 && (
        <section>
          <h2 className="text-md font-bold mb-2 border-b uppercase tracking-widest" style={{ color: accentColor }}>
    ...
    {/* FOOTER GRID: Education and Skills pinned at bottom */}
    <div className="resume-grid border-t pt-3 shrink-0" style={{ borderColor: `${accentColor}20` }}>
      {hasEducation && (
        <section>
          <h2 className="text-md font-bold mb-1.5 uppercase tracking-widest" style={{ color: accentColor }}>
            Education
          </h2>
