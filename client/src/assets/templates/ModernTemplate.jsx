...
const ModernTemplate = ({ data, accentColor }) => {
    ...
    return (
        <div className="w-[210mm] min-h-[297mm] h-full flex flex-col justify-between bg-white text-gray-800 font-sans overflow-hidden break-words shadow-lg print:shadow-none">
            <div>
                {/* HEADER */}
                <header className="px-8 py-5 text-white shrink-0" style={{ backgroundColor: accentColor }}>
                        ...
                        <section>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {data.skills.map((skill, index) => (
                                    <span key={index} className="px-2.5 py-1 text-xs font-bold text-white rounded shadow-xs" style={{ backgroundColor: accentColor }}>
                                        {skill}
                                    </span>
                                ))}
                            </div>
