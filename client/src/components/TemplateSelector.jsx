...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
       id: 'professional',
       name: 'Professional',
       preview: "Clean, structured, and optimized for ATS parsing."
    }
  ];
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          className="absolute top-full w-64 p-3 mt-2 space-y-3 z-10
          ...
          {templates.map((template) => (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <div className='mt-2 p2 bg-blue-50 rounded text-xs text-gray-500 italic'>{template.preview}</div>
              </div>
            </div>
          ))}
        </div>
